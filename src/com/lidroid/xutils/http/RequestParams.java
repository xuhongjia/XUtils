...
public class RequestParams {
	...
	public RequestParams(Object... objects) {
		if (objects == null || objects.length % 2 != 0) {
			return;
		}
		for (int i = 1; i < objects.length; i += 2) {
			addBodyParameter(String.valueOf(objects[i - 1]),
					String.valueOf(objects[i]));
		}
	}

	public RequestParams(Object object) {
		if (object == null)
			return;
		...
		for (Field field : fields) {
			...
			try {
				...
				if (valueObject == null)
					continue;
				addBodyParameter(field.getName(), valueObject.toString());
	...
	// liuzw.
	public List<NameValuePair> getBodys() {
		return bodyParams;
	}
	...
	public class HeaderItem {
		...
		public boolean equals(Object other) {
			if (other == null || !(other instanceof Header)) {
				return false;
			}
			if (this.header == null || this.header.getName() == null) {
				return false;
			}
			if (this.header.getName().equals(
					((HeaderItem) other).header.getName())) {
				return true;
			}
			return false;
		}
		...
		public int hashCode() {
			if (this.header == null)
				return 0;
			return this.header.getName().hashCode();
		}
	}
}