...
public abstract class RequestCallBack<T> {
	...
	public void onSuccess(ResponseInfo<Object> responseInfo, boolean isFromCache) {
		System.out.println("onSuccess");
	};
	...
	// 增加一种直接获取到想要数据的方式.需要通过onParseData接口转换数据.
	// 如果没有重写onParseData,则不调用此接口.
	public void onSuccess(T responseData, boolean isFromCache) {
	}

	// 需要实现数据解析的工作,否则得到一个responseInfo也仅能得到字符串响应.
	public T onParseData(String responseData) {
		return null;
	}
}
