...
public class HttpUtils {
	...
	private ISecureInterceptor secureInterceptor = new SimpleSecurityHandler();
	...
	// *******************************************
	// 配置网络请求的安全验证器.liuzw.
	public void configSecureInterceptor(ISecureInterceptor interceptor) {
		if (interceptor == null)
			return;
		this.secureInterceptor = interceptor;
	}
